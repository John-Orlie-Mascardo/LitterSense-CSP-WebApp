...
export function TopBar() {
  return (
    <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-[#D1D5DB] z-40">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-[#1B7A6E] flex items-center justify-center">
            <svg
              viewBox="0 0 24 24"
          ...
          <span className="font-display font-bold text-xl text-[#1B7A6E]">
            LitterSense
          </span>
        </div>
