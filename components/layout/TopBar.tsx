...
export function TopBar() {
  return (
    <header className="fixed top-0 left-0 right-0 bg-litter-card/95 backdrop-blur-sm border-b border-litter-border z-40">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-litter-primary flex items-center justify-center">
            <svg
              viewBox="0 0 24 24"
          ...
          <span className="font-display font-bold text-xl text-litter-primary">
            LitterSense
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard/notifications">
            <button className="relative p-2 rounded-xl hover:bg-litter-bg transition-colors">
              <Bell className="w-6 h-6 text-litter-text" />
          ...
          {/* User avatar */}
          <button className="w-10 h-10 rounded-full bg-litter-primary-light flex items-center justify-center text-litter-primary font-medium hover:bg-litter-primary hover:text-white transition-colors">
